...
if ($status -and -not $SkipCommit) {
  ...
  Invoke-Checked "git" @("add", "admin-gui", "deploy/artserver/admin", "scripts/publish-admin-gui.ps1", "publish-admin-gui.cmd", "artserver-apps.json", "artserver-script-catalog.json", "admin-gui/README.md", "deploy/artserver/admin/README.md")
